  ...
  return (
    <div className="font-inter">
      {location?.pathname === "/" ? <div className='bg-white  p-2 flex justify-between items-center'>
        ...
        : location?.pathname === "/activity" ? <h1 className=" w-full bg-gradient-to-l from-[#f95959] to-[#ff9a8e] text-white text-center text-2xl py-3 z-10">TirangaWin</h1>
          : location?.pathname === "/activity/award" ? <header className='bg-gradient-to-l from-[#f95959] to-[#ff9a8e] px-3'>
