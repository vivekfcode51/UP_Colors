...
function Withdrawal() {
    ...
    return (
        <div className='mx-3'>
            ...
            <p className='text-sm font-bold mt-7'>Pay using:</p>
            ...
            {activeModal === "UPI" && (
                <div className="mt-5 ">
                    <div className='bg-slate-300 shadow-lg rounded-lg p-2'>
                        <button className='w-full'>
                            <Link to="/wallet/withdrawal/addbankaccount" className="flex flex-col items-center rounded-l-full text-sm mt-3 p-1" >
                                <p className="w-10 h-10 rounded-sm border-2 border-dashed border-gray text-gray flex items-center justify-center">+</p>
                                <h3 className="text-sm mt-2 font-semibold text-gray flex items-center ">
                                    Add a bank account number
                                </h3>
                            </Link>
                        </button>
                    </div>
                    <div className='bg-white shadow-lg rounded-lg p-2 mt-5 mb-10'>
                        <p className='text-xs text-gray font-bold'>Need to add beneficiary information to be able to withdraw money</p>
                        <div className="flex items-center bg-gray rounded-l-full text-sm mt-3  p-1">
                            <div className="w-8 flex items-center justify-center text-lg text-bg2">₹</div>
                            <input
                                type="number"
                        ...
                        <button className="mt-4 w-full bg-gray text-white py-3 font-bold rounded-full border-none text-xs hover:bg-blue-600">
                            Withdraw
                        </button>
            ...
            {activeModal === "USDT" && (
                <div className="mt-5 ">
                    ...
                    <div className='bg-white shadow-lg rounded-lg p-2 mt-5 mb-10'>
                        ...
                        <div className="flex items-center bg-gray border-bg3 border-2 text-sm mt-3  p-1">
